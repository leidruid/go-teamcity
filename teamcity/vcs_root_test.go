...
func TestGitVcsRoot_Update(t *testing.T) {
	...
	opt, _ := teamcity.NewGitVcsRootOptionsWithAgentSettings(
		"refs/head/develop",
		"https://github.com/leidruid/go-teamcity",
		"",
	...
	assert.Equal("https://github.com/leidruid/go-teamcity", actualOpt.FetchURL)
...
func TestGitVcsRoot_CreateWithUsernamePassword(t *testing.T) {
	...
	opts, _ := teamcity.NewGitVcsRootOptions("refs/head/master", "https://github.com/leidruid/go-teamcity/", "", teamcity.GitAuthMethodPassword, "admin", "admin")
...
func TestGitVcsRoot_Invariants(t *testing.T) {
	gitOpt, _ := teamcity.NewGitVcsRootOptionsDefaults("master", "https://github.com/leidruid/go-teamcity/")
...
func getTestVcsRootData(projectId string) teamcity.VcsRoot {
	opts, _ := teamcity.NewGitVcsRootOptionsDefaults("refs/head/master", "https://github.com/leidruid/go-teamcity")
